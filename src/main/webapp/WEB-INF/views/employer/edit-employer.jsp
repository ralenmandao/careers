...
<link
	href="${resources}assets/third/font-awesome/css/font-awesome.min.css"
	rel="stylesheet">
<link
	href="${resources}assets/third/weather-icon/css/weather-icons.min.css"
	rel="stylesheet">
<link href="${resources}assets/third/morris/morris.css" rel="stylesheet">
<link href="${resources}assets/third/nifty-modal/css/component.css"
	rel="stylesheet">
<link
	href="${resources}assets/third/sortable/sortable-theme-bootstrap.css"
	rel="stylesheet">
<link href="${resources}assets/third/icheck/skins/minimal/grey.css"
	rel="stylesheet">
<link href="${resources}assets/third/select/bootstrap-select.min.css"
	rel="stylesheet">
<link href="${resources}assets/third/summernote/summernote.css"
	rel="stylesheet">
<link href="${resources}assets/third/magnific-popup/magnific-popup.css"
	rel="stylesheet">
<link href="${resources}assets/third/datepicker/css/datepicker.css"
	rel="stylesheet">
...
<body class="tooltips">
	...
	<div class="body content rows scroll-y" id="body-container">
		<div class="box-info">
			...
			<form class="form-horizontal" role="form" method="post"
				action="/employer/edit" id="edit-company-form">
				<div class="form-group" id="grp-industry">
					<label for="input-text" class="col-sm-2 control-label" id="lbl-industry">Industry</label>
					<div class="col-sm-10">
						<select data-placeholder="Choose company industries..."
							class="chosen-select form-control" multiple tabindex="5"
							name="industries" id="industry-select">
							<option value=""></option>
				...
				<div class="form-group" id="grp-location">
					<label for="input-text" class="col-sm-2 control-label" id="lbl-location">Location</label>
					<div class="col-sm-10">
						<select data-placeholder="State"
							class="chosen-select form-control" id="location-select"
				...
				<div class="form-group">
					<label for="input-text" class="col-sm-2 control-label">Company
						Size</label>
					<div class="col-sm-10">
						<input type="text" value="${principal.size}" class="form-control"
							id="input-text" name="companySize" placeholder="">
					</div>
				</div>
				<div class="form-group">
					<label for="input-text" class="col-sm-2 control-label">Company
					...
					<div class="col-sm-10">
						<textarea class="summernote-small form-control"
							name="companyOverview">${principal.overview}</textarea>
					</div>
				</div>
	...
	<!-- Slimscroll js -->
	<script
		src="${resources}assets/third/slimscroll/jquery.slimscroll.min.js"></script>
	...
	<!-- Magnific popup js -->
	<script
		src="${resources}assets/third/magnific-popup/jquery.magnific-popup.min.js"></script>
	...
	<script
		src="${resources}assets/third/datepicker/js/bootstrap-datepicker.js"></script>

	<!-- Icheck js -->
	<script src="${resources}assets/third/icheck/icheck.min.js"></script>

	<script
		src="${resources}assets/third/validator/bootstrapValidator.min.js"></script>
	...
	<script>
				...
				.click(
						function() {
							...
							if ($('#location-select').val() == '') {
								$('#location-select + div').css(
										'border-radius', '6px')
								$('#location-select + div').css('border',
										'2px solid #a94442')
								$('#lbl-location').css('color', '#a94442')
								$('#grp-location')
										.append(
												'<small class="help-block col-sm-offset-3 col-sm-9" style="color:#a94442">please select a location</small>');
								noError = false;
							}

							if ($('#industry-select + div > ul').text() == '') {
								$('#industry-select + div').css('border',
										'2px solid #a94442')
								$('#lbl-industry').css('color', '#a94442')
								$('#grp-industry')
										.append(
												'<small class="help-block col-sm-offset-3 col-sm-9" style="color:#a94442">please select an industry</small>');
								noError = false;
							}
							return noError;
						});
		...
		$("#location-select").chosen().change(function(event) {
			if ($(event.target).val() != '') {
				$('#location-select + div').css('border-radius', '')
				$('#location-select + div').css('border', '')
				$('#lbl-location').css('color', '')
				$('small:last-child', $('#grp-location')).remove();
			}
		});
		
		$('#edit-company-form').bootstrapValidator({
