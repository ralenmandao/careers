...
<head>
<title>Careers CCS - Employer Registration</title>
...
<body class="tooltips full-content">
			...
			<div class="login-wrap">
				<div class="box-info">
					<h2 class="text-center">
						<strong>Register</strong> New Employer Account
					</h2>
					...
					<form:form modelAttribute="employerRegistration" role="form"
						...
						<div class="form-group login-input">
							<i class="fa fa-key overlay"></i> <input type="password"
								class="form-control text-input" id="repassword" name="repassword"
								placeholder="Re-type Password" data-parsley-required="true"
								data-parsley-minlength="3"
								data-parsley-maxlength="20"/>
						</div>
				...
				<p class="text-center">
					<a href="login.html"><i class="fa fa-sign-in"></i> Go to
						login</a>
				</p>
	...
	$('#employerRegistration').click(function(){
		if(document.getElementById('agree').checked == false){
			$('#agg-error').remove();
			$('#employerRegistration').append('<small id="agg-error" class="help-block" style="color:red">Accept the Terms and Conditions before registration</small>')
			return false;
		}
		$('#agg-error').remove();
		return true;
