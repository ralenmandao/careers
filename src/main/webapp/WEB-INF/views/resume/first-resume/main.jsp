...
<link
	href='http://fonts.googleapis.com/css?family=Roboto+Slab:700,400|Shadows+Into+Light+Two'
	rel='stylesheet' type='text/css'>
<spring:url value="/resources/" var="resources" />
<spring:url value="/WEB-INF/views/" var="views" />
<spring:url value="/" var="root" />
<link href="${resources}assets/css/resume/resume1/theme.css"
	rel="stylesheet">
						...
						<div class="well">
							...
							<div class="intro">
								<h1 style="text-transform: capitalize;">
									<b>Hello,</b> I am ${candidate.firstName} ${candidate.lastName}
								</h1>
							</div>
						</div>
					</div>
										...
										<div class="timeline-heading">
											...
											<p>
												<small class="text-muted"><i class="fa fa-time"></i>
													From ${candidate.highSchool.startYear} -
													${candidate.highSchool.endYear}</small>
											</p>
										</div>
									</div>
								</li>
								<li class="timeline-inverted">
									...
									<div class="timeline-panel">
										<div class="timeline-heading">
											...
											<p>
												<small class="text-muted"><i class="fa fa-time"></i>
													From ${candidate.college.startYear} -
													${candidate.college.endYear}</small>
											</p>
										</div>
									</div>
								</li>
											...
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion"
														href="#collapseOne"> ${exp.position}
														(${exp.startYear}-${exp.endYear}) - ${exp.companyName} </a>
												</h4>
											</div>
											<div id="collapseOne" class="panel-collapse collapse in">
												<div class="panel-body">${exp.role}</div>
											</div>
										</div>
									</c:forEach>
								</div>
