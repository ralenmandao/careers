...
<head>
	<title>Careers CCS - Manage Field of Studies</title>
	...
	<body class="tooltips">	
		...
		<!-- ============================================================== -->
         <div class="scroll-y" id="body-container">
			<div class="body content rows scroll-y">
				<div class="box-info">
					<h2><strong>Field of Studies</strong> table</h2>
					...
					<div style="display:none;" id="edit-country">
						<h2><strong>Edit</strong> Field</h2>
						<form class="form-horizontal" role="form" action="/admin/field/edit">
							<div class="form-group">
								<label for="input-text" class="col-sm-2 control-label">Field</label>
					...
					<div style="display:none;" id="add-country">
						<h2><strong>Add</strong> Field</h2>
						<form class="form-horizontal" role="form" action="/admin/field/add">
							<div class="form-group">
								<label for="input-text" class="col-sm-2 control-label">Field</label>
								<div class="col-sm-10" id="firstNameContainer">
		...
		$(document).ready(function(){
			$('.delete-candidate').on('click', function(){
				...
				$('#delete-url').attr('href', '/admin/field/' + $(this).attr('data-id') + '/delete')
			})
