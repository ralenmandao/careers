...
<head>
	<title>Careers CCS - Manage Skills</title>
	...
	<body class="tooltips">	
			...
			<div class="body content rows scroll-y">
				<div class="box-info">
									...
									<tr>
										...
										<td>
											<div class="btn-group btn-group-xs">
												<a data-id="${skill.id}" candidate-name="${skill.name}" data-modal="confirm-delete-modal" data-toggle="tooltip" title="" class="btn btn-default md-trigger delete-candidate" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
					...
					<div style="display:none;" id="edit-country">
						...
						<form class="form-horizontal" role="form" action="/admin/skill/edit" id="editCountry">
					...
					<div style="display:none;" id="add-country">
						...
						<form class="form-horizontal" role="form" action="/admin/skill/add" id="addCountry">
							<div class="form-group">
								<label for="input-text" class="col-sm-2 control-label">Skill</label>
								<div class="col-sm-10" id="firstNameContainer">
		...
		$(document).ready(function(){
			...
			$('#skills-menu').css('background', '#219CC4');
			$('#skills-menu a').css('color', 'white');	
