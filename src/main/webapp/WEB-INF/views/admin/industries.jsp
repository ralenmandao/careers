			...
			<div class="body content rows scroll-y">
				<div class="box-info">
									...
									<tr>
										...
										<td>
											<div class="btn-group btn-group-xs">
												<a data-id="${industry.id}" candidate-name="${industry.name}" data-modal="confirm-delete-modal" data-toggle="tooltip" title="" class="btn btn-default md-trigger delete-candidate" data-original-title="Delete"><i class="fa fa-power-off"></i></a>
					...
					<div style="display:none;" id="edit-country">
						...
						<form class="form-horizontal" role="form" action="/admin/industry/edit">
					...
					<div style="display:none;" id="add-country">
						...
						<form class="form-horizontal" role="form" action="/admin/industry/add">
							<div class="form-group">
