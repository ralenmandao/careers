...
<head>
	<title>Careers CCS - Manage Industries</title>
	...
	<body class="tooltips">	
			...
			<div class="body content rows scroll-y">
				<div class="box-info">
									...
									<tr>
										...
										<td>
											<div class="btn-group btn-group-xs">
												<a data-id="${industry.id}" candidate-name="${industry.name}" data-modal="confirm-delete-modal" data-toggle="tooltip" title="" class="btn btn-default md-trigger delete-candidate" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
												<a href="#" data-id = "${industry.id}" data-name="${industry.name}" data-toggle="tooltip" title="" class="btn btn-default edit-candidate" data-original-title="Edit"><i class="fa fa-edit"></i></a>
											</div>
										</td>
									</tr>
								</c:forEach>
					...
					<div style="display:none;" id="edit-country">
						<h2><strong>Edit</strong> Industry</h2>
						<form class="form-horizontal" role="form" action="/admin/industry/edit" id="editCountry">
					...
					<div style="display:none;" id="add-country">
						<h2><strong>Add</strong> Industry</h2>
						<form class="form-horizontal" role="form" action="/admin/industry/add" id="addCountry">
							<div class="form-group">
		...
		$(document).ready(function(){
			$('.delete-candidate').on('click', function(){
				...
				$('#delete-url').attr('href', '/admin/industry/' + $(this).attr('data-id') + '/delete')
			})
			...
			$('#industries-menu').css('background', '#219CC4');
			$('#industries-menu a').css('color', 'white');
